  ...
  ast.forEach(function (tag) {
    ...
    switch (tag.kind) {
      case 'file':
        ...
        (currentFunction || result).deprecated = tag.deprecated || false;
        break;
      case 'function':
		...
		fn.printname	 = tag.longname.replace("module:" + tag.moduleName + "~", "");		
        currentFunction = fn;
        if (currentClass) {
          currentClass.methods.push(fn);
          fn.className = currentClass ? currentClass.name : '';
        } else if (currentModule) {
          currentModule.hasFunctions = true;
      ...
      case 'namespace':
        var module = {};
        module.license   = tag.license;
        module.author    = tag.author;
        module.copyright = tag.copyright;        
        module.name = tag.name;
        module.overview = tag.overview;       
        module.longname = tag.longname;
		module.printname = tag.longname.replace("module:", "");
